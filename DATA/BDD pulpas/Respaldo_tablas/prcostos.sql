...
-- ULTIMO SP DE REGISTRAR PORDUCCION FUNCIONANDO 28/2/25   aunque registra doble vez si se hace el
-- llamdo desde base de datos desde el sistema si registra una sola vez correctamente 
